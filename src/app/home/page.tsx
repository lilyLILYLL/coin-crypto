...
const Home = () => {
    ...
    return (
        <section
            id="home"
            className="pt-[200px] min-h-screen w-full text-3xl  bg-gradient-to-t from-black from-30% to-darkPurple lg:p-28 lg:pt-[200px] p-10 "
        >
            {/* TITTLE */}
            <Tittle
                name="TRACK AND TRADE CRYPTO CURRENCIES"
                gradientFrom={3}
            />
